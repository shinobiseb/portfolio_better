  ...
  return (
    <>
      <div className='z-10 h-full w-full flex flex-col justify-center items-center overflow-hidden'>
        <main className='clip h-5/6 w-5/6 bg-orange p-2 sm:p-8 flex justify-between flex-col md:flex-row overflow-y-auto'>
          <section className='h-full w-full md:w-1/3 flex flex-col justify-between p-3'>
            <h3 className='text-xl sm:text-3xl font-semibold'>About Sebastian</h3>
              <p className='mt-1 text-sm sm:text-lg h-full flex flex-col'>
          ...
          <main className='w-full md:w-2/3 h-full text-sm sm:text-lg'>
